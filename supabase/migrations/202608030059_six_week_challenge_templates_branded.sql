-- Rebrands The 6 Week Challenge email templates with the MJG-branded shell
-- (centered logo, hero, full-width video placeholder, content, buttons, CTA band,
-- signature with logo, and footer). Updates html_body by slug; idempotent.
...
update public.email_templates set html_body = $html$<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1eee7;padding:24px 0;margin:0;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:0px 40px 0px;"><div style="border-top:1px solid #e7e1d5;font-size:0;line-height:0;">&nbsp;</div></td></tr>
      <tr><td style="padding:28px 40px 8px;"><p style="margin:0 0 10px;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">The Life You&rsquo;re Building &middot; 6-Week Men&rsquo;s Study</p><h1 style="margin:0;font-family:Georgia, 'Times New Roman', serif;font-size:30px;line-height:1.15;color:#191815;font-weight:700;">Week 2 &mdash; See the Blueprint</h1><p style="margin:12px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:15px;line-height:1.6;color:#7a736a;">Clarify bedrock, identity, values, mission, and daily purpose.</p></td></tr>
      <tr><td style="padding:14px 40px 10px;"><a href="{{video_url}}" style="text-decoration:none;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e7e1d5;border-radius:8px;background:#faf8f4;">
          <tr><td align="center" style="padding:46px 20px;">
            <div style="width:54px;height:54px;line-height:54px;border-radius:50%;background:#C9A46E;color:#191815;font-size:20px;text-align:center;margin:0 auto 12px;">&#9654;</div>
            <p style="margin:0;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">Week 2 Video</p>
            <p style="margin:6px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:13px;color:#7a736a;">Watch this week&rsquo;s short teaching video</p>
          </td></tr>
        </table></a></td></tr>
      ...
      <tr><td style="padding:6px 40px 18px;"><div style="text-align:center;"><a href="{{video_url}}" style="display:inline-block;background:#C9A46E;color:#191815;text-decoration:none;padding:13px 26px;border-radius:6px;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:700;margin:4px;">&#9654; Watch the Week 2 video</a></div></td></tr>
...
update public.email_templates set html_body = $html$<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1eee7;padding:24px 0;margin:0;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:0px 40px 0px;"><div style="border-top:1px solid #e7e1d5;font-size:0;line-height:0;">&nbsp;</div></td></tr>
      <tr><td style="padding:28px 40px 8px;"><p style="margin:0 0 10px;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">The Life You&rsquo;re Building &middot; 6-Week Men&rsquo;s Study</p><h1 style="margin:0;font-family:Georgia, 'Times New Roman', serif;font-size:30px;line-height:1.15;color:#191815;font-weight:700;">Week 3 &mdash; Evaluate the Pillars</h1><p style="margin:12px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:15px;line-height:1.6;color:#7a736a;">Assess family, fitness, fun, and finances; choose one priority.</p></td></tr>
      <tr><td style="padding:14px 40px 10px;"><a href="{{video_url}}" style="text-decoration:none;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e7e1d5;border-radius:8px;background:#faf8f4;">
          <tr><td align="center" style="padding:46px 20px;">
            <div style="width:54px;height:54px;line-height:54px;border-radius:50%;background:#C9A46E;color:#191815;font-size:20px;text-align:center;margin:0 auto 12px;">&#9654;</div>
            <p style="margin:0;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">Week 3 Video</p>
            <p style="margin:6px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:13px;color:#7a736a;">Watch this week&rsquo;s short teaching video</p>
          </td></tr>
        </table></a></td></tr>
      ...
      <tr><td style="padding:6px 40px 18px;"><div style="text-align:center;"><a href="{{video_url}}" style="display:inline-block;background:#C9A46E;color:#191815;text-decoration:none;padding:13px 26px;border-radius:6px;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:700;margin:4px;">&#9654; Watch the Week 3 video</a></div></td></tr>
...
update public.email_templates set html_body = $html$<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1eee7;padding:24px 0;margin:0;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:0px 40px 0px;"><div style="border-top:1px solid #e7e1d5;font-size:0;line-height:0;">&nbsp;</div></td></tr>
      <tr><td style="padding:28px 40px 8px;"><p style="margin:0 0 10px;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">The Life You&rsquo;re Building &middot; 6-Week Men&rsquo;s Study</p><h1 style="margin:0;font-family:Georgia, 'Times New Roman', serif;font-size:30px;line-height:1.15;color:#191815;font-weight:700;">Week 4 &mdash; Install the Guardrails</h1><p style="margin:12px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:15px;line-height:1.6;color:#7a736a;">Build specific boundaries that protect what matters most.</p></td></tr>
      <tr><td style="padding:14px 40px 10px;"><a href="{{video_url}}" style="text-decoration:none;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e7e1d5;border-radius:8px;background:#faf8f4;">
          <tr><td align="center" style="padding:46px 20px;">
            <div style="width:54px;height:54px;line-height:54px;border-radius:50%;background:#C9A46E;color:#191815;font-size:20px;text-align:center;margin:0 auto 12px;">&#9654;</div>
            <p style="margin:0;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">Week 4 Video</p>
            <p style="margin:6px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:13px;color:#7a736a;">Watch this week&rsquo;s short teaching video</p>
          </td></tr>
        </table></a></td></tr>
      ...
      <tr><td style="padding:6px 40px 18px;"><div style="text-align:center;"><a href="{{video_url}}" style="display:inline-block;background:#C9A46E;color:#191815;text-decoration:none;padding:13px 26px;border-radius:6px;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:700;margin:4px;">&#9654; Watch the Week 4 video</a></div></td></tr>
...
update public.email_templates set html_body = $html$<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1eee7;padding:24px 0;margin:0;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:0px 40px 0px;"><div style="border-top:1px solid #e7e1d5;font-size:0;line-height:0;">&nbsp;</div></td></tr>
      <tr><td style="padding:28px 40px 8px;"><p style="margin:0 0 10px;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">The Life You&rsquo;re Building &middot; 6-Week Men&rsquo;s Study</p><h1 style="margin:0;font-family:Georgia, 'Times New Roman', serif;font-size:30px;line-height:1.15;color:#191815;font-weight:700;">Week 5 &mdash; Strengthen the Structure</h1><p style="margin:12px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:15px;line-height:1.6;color:#7a736a;">Design keystone habits and steward energy.</p></td></tr>
      <tr><td style="padding:14px 40px 10px;"><a href="{{video_url}}" style="text-decoration:none;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e7e1d5;border-radius:8px;background:#faf8f4;">
          <tr><td align="center" style="padding:46px 20px;">
            <div style="width:54px;height:54px;line-height:54px;border-radius:50%;background:#C9A46E;color:#191815;font-size:20px;text-align:center;margin:0 auto 12px;">&#9654;</div>
            <p style="margin:0;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">Week 5 Video</p>
            <p style="margin:6px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:13px;color:#7a736a;">Watch this week&rsquo;s short teaching video</p>
          </td></tr>
        </table></a></td></tr>
...
update public.email_templates set html_body = $html$<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1eee7;padding:24px 0;margin:0;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:6px 40px 18px;"><div style="text-align:center;"><a href="{{video_url}}" style="display:inline-block;background:#C9A46E;color:#191815;text-decoration:none;padding:13px 26px;border-radius:6px;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:700;margin:4px;">&#9654; Watch the Week 6 video</a></div></td></tr>
...
update public.email_templates set html_body = $html$<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1eee7;padding:24px 0;margin:0;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:6px 40px 18px;"><div style="text-align:center;"><a href="{{video_url}}" style="display:inline-block;background:#C9A46E;color:#191815;text-decoration:none;padding:13px 26px;border-radius:6px;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:700;margin:4px;">&#9654; Share the invite video</a></div></td></tr>
      <tr><td style="padding:26px 40px 8px;"><div>
        <img src="https://michaeljgauthier.com/mjg-logos/mjg_black_white.png" width="42" alt="MJG" style="display:block;width:42px;height:auto;margin:0 0 8px;" />
        <p style="margin:0;font-family:Georgia, 'Times New Roman', serif;font-size:18px;color:#191815;">Michael J. Gauthier</p>
        <p style="margin:2px 0 0;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.1em;text-transform:uppercase;color:#7a736a;">Author &middot; The Stewardship Blueprint</p>

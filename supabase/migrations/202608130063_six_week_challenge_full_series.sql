-- The Life You're Building — 6-Week Challenge — full 21-email participant automation series.
-- Rewrites the 6 existing weekly launch templates and adds 15 new participant emails
-- (Email 0–20) from docs/6-week-challenge, all in the branded shell (see migration 061).
-- Also wires the "6 Week Challenge" experience type's automation sequence with the doc's
-- relative timing. Idempotent (upsert by slug; steps rebuilt).
--
-- Schedule anchor: the experience start_date = the enrollment / kickoff day (Email 0).
-- Week 1 session falls ~7 days later; each later week +7 days. Offsets below are DAYS
-- from that kickoff day, preserving the document's ordering and cadence.
...
— Michael J. Gauthier
michaeljgauthier.com$txt$, 'six_week_challenge', 'draft', '{first_name,last_name,full_name,video_url,guide_url,book_waitlist_url,forgedlife_url,invite_url,feedback_url,followup_url,calendar_url,preferences_url,unsubscribe_url}')
...
values ('6WC · 03 · Week 1 — Wake Up', '6wc-participant-week-1', 'Week 1: Wake Up — {{first_name}}, what are you building?', 'Drift is subtle. Design is intentional. This week we start telling the truth.', $html$<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1eee7;padding:24px 0;margin:0;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:8px 40px 36px;"><a href="{{video_url}}" style="text-decoration:none;display:block;"><img src="https://michaeljgauthier.com/email-assets/video-placeholder.png" width="520" alt="Watch this week&rsquo;s video" style="display:block;width:100%;max-width:520px;height:auto;border:0;margin:0 auto;border-radius:12px;" /></a></td></tr>
...
values ('6WC · 06 · Week 2 Follow-Up', '6wc-participant-06-week-2-followup', 'Week 2 follow-up: put it where you can see it', 'A value you never protect may be more preference than priority.', $html$<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f1eee7;padding:24px 0;margin:0;">
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="background:#191815;padding:40px 40px 40px;"><p style="margin:0 0 8px;font-family:Arial, Helvetica, sans-serif;font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:#C9A46E;font-weight:700;">Go Deeper</p><h2 style="margin:0 0 10px;font-family:Georgia, 'Times New Roman', serif;font-size:22px;line-height:1.25;color:#ffffff;font-weight:700;">Join the book updates list</h2><p style="margin:0 0 22px;font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:1.7;color:#d8d2c8;">The Life You&rsquo;re Building goes deeper into this framework through story, Scripture, reflection, and practical action. Get updates, tools, and behind-the-scenes pieces as we go.</p><div><a href="{{book_waitlist_url}}" style="display:inline-block;background:#C9A46E;color:#191815;text-decoration:none;padding:13px 26px;border-radius:6px;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:700;">Join the list &rarr;</a></div></td></tr>
      <tr><td style="padding:44px 40px 32px;"><div>
        <img src="https://michaeljgauthier.com/mjg-logos/mjg_black_white.png" width="42" alt="MJG" style="display:block;width:42px;height:auto;margin:0 0 8px;" />
        <p style="margin:0;font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#7a736a;">Keep building,</p>
        <p style="margin:2px 0 0;font-family:Georgia, 'Times New Roman', serif;font-size:18px;color:#191815;">Michael J. Gauthier</p>
...
-- Type-level step defaults gain an offset so a program's cadence isn't forced to be uniform.
...
-- Wire the "6 Week Challenge" experience type sequence to the 21-email series.
do $$
declare
  v_type_id uuid;
begin
  select id into v_type_id from public.experience_types where slug = 'six-week-challenge' limit 1;
  if v_type_id is null then
    raise notice '6 Week Challenge experience type not found; skipping step wiring.';
    return;
  end if;
  ...
  from (values
    (1, 'Challenge Accepted (at enrollment)', '6wc-participant-00-challenge-accepted', 0),
    (2, 'Welcome & What to Expect (~7 days before Week 1)', '6wc-participant-01-welcome', 1),
    (3, 'Start Strong Reminder (~48h before Week 1)', '6wc-participant-02-start-strong', 5),
    (4, 'Week 1 Launch: Wake Up', '6wc-participant-week-1', 7),
    (5, 'Week 1 Action Follow-Up', '6wc-participant-04-week-1-followup', 8),
    (6, 'Week 2 Launch: See the Blueprint', '6wc-participant-week-2', 10),
    (7, 'Week 2 Action Follow-Up', '6wc-participant-06-week-2-followup', 15),
    (8, 'Week 3 Launch: Evaluate the Pillars', '6wc-participant-week-3', 17),
    (9, 'Week 3 Action Follow-Up', '6wc-participant-08-week-3-followup', 22),
    (10, 'Midpoint Pulse (after Week 3)', '6wc-participant-09-midpoint-pulse', 23),
    (11, 'Week 4 Launch: Install the Guardrails', '6wc-participant-week-4', 24),
    (12, 'Week 4 Action Follow-Up', '6wc-participant-11-week-4-followup', 29),
    (13, 'Week 5 Launch: Strengthen the Structure', '6wc-participant-week-5', 31),
    (14, 'Week 5 Action Follow-Up', '6wc-participant-13-week-5-followup', 36),
    (15, 'Week 6 Launch: Design My Life', '6wc-participant-week-6', 38),
    (16, 'Finish Strong Reminder (~24h before Week 6)', '6wc-participant-15-finish-strong', 41),
    (17, 'Final Thank-You and Next Step', '6wc-participant-16-final-thankyou', 43),
    (18, 'Keep Building (7 days after Week 6)', '6wc-participant-17-keep-building', 49),
    (19, 'Do Not Drift Back Quietly (21 days after Week 6)', '6wc-participant-18-do-not-drift', 63),
    (20, '30-Day Check-In: What Lasted?', '6wc-participant-19-30-day-checkin', 72),
    (21, 'Multiply It (35-45 days after Week 6)', '6wc-participant-20-multiply-it', 80)
  ) as s(step_number, label, slug, offset_value)
  join public.email_templates t on t.slug = s.slug;

  update public.experience_types set default_duration_weeks = 21, updated_at = now() where id = v_type_id;
end $$;
